...
public class AdBlocker {
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		Job job=Job.getInstance(conf,"AdBlocker"); 
		job.setJarByClass(AdBlocker.class);
		...
		Path outputPath = new Path("/StackOverflow/result/AdBlocker");
	...
	public static class MyReducer extends Reducer<Text,IntWritable, Text,NullWritable>{
		...
		protected void reduce(Text key, Iterable<IntWritable> values,Context context) 
				throws IOException, InterruptedException {
			if("I'm not sure/I don't know".equals(key.toString()))
			{
